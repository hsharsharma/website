...
const config = {
  seo: {
    title: 'AML Compliance for Accountants | Tranche 2 Software | Lead AML',
    description: 'Protect your accounting firm from Tranche 2 risks. Lead AML provides expert consulting, automated KYC, and compliance software tailored for Australian accountants.',
    keywords: ['AML for accountants', 'Tranche 2 compliance for accounting firms', 'AML software for accountants', 'KYC for accounting clients', 'accounting firm risk assessment', 'Tranche 2 obligations Australia'],
    path: '/Sectors/Accountants',
  },
  hero: {
    sectorName: 'Accountants',
    label: 'AML for Accountants',
    headline: 'Tranche 2 AML Compliance Solutions for Accounting Firms',
  ...
  obligationsSection: {
    title: 'Why Accountants Must Prepare for July 2026',
  ...
  risksSection: {
    title: 'Risk Profiling Specifically for Tax and Advisory Services',
  ...
  howWeHelpSection: {
    title: 'Seamless Name & Sanctions Screening',
