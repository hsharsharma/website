            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--brand-slate-light)]">30-minute no-obligation session with an AML expert to discuss your compliance needs.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--brand-slate-light)]">Get ahead of compliance requirements with practical, industry-specific guidance.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--brand-slate-light)]">We'll get back to you within 24 hours to confirm your consultation time.</p>
                </div>
              </div>
            </motion.div>
