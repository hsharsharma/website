...
function HowWeHelpSection({ title, intro, bullets }) {
  return (
    <section className="hero-gradient py-10 md:py-20">
      <div className="max-w-7xl mx-auto px-6">
            ...
            return (
              <div key={i} className="group bg-white rounded-2xl p-6 border border-gray-100 hover:shadow-xl hover:shadow-blue-900/20 transition-all duration-300">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-[var(--brand-blue-light)] flex items-center justify-center flex-shrink-0 group-hover:bg-[var(--brand-blue)] transition-colors duration-300">
                    <ChevronRight className="h-5 w-5 text-[var(--brand-blue)] group-hover:text-white transition-colors duration-300" />
                  </div>
                  <div>
                    {bold
...
export default function SectorPage({ seo, hero, obligationsSection, risksSection, howWeHelpSection, icon: Icon }) {
  ...
  return (
    <div>
      ...
      {/* ── Hero ──────────────────────────────────────────────────────── */}
      <section className="hero-gradient pt-10 pb-16 md:pt-20 md:pb-24 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative">
          ...
          <p className="text-blue-200 text-base md:text-xl leading-relaxed mb-10 max-w-2xl">
            {hero.subheadline}
          </p>
